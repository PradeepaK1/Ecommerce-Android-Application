...
public class Main19Activity extends AppCompatActivity {
    ...
    String Storage_Path = "All_Shop_Uploads/";

    String Database_Path = "All_Shop_Uploads_Database";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Main19Activity.this);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
           ...
           progressDialog.setTitle("adding shop...");
            ...
            storageReference2nd.putFile(FilePathUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(Main19Activity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(Main19Activity.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
