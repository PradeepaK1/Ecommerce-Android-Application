...
public class ProductActivity extends AppCompatActivity {
    ...
    private TextView productSize, productColor, productPrice, productDescription, productName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(singleProduct != null){
            ...
            productName.setText("Name: " + singleProduct.getProductName());
            productSize.setText("Quantity: " + String.valueOf(singleProduct.getProductQuantity()));
            productColor.setText("Category: " + singleProduct.getProductCategory());
